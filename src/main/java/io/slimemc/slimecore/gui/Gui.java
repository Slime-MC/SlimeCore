...
import io.slimemc.slimecore.compatibility.CompatibleSound;
import io.slimemc.slimecore.compatibility.ServerVersion;
import io.slimemc.slimecore.gui.events.*;
import io.slimemc.slimecore.gui.methods.*;
import io.slimemc.slimecore.utils.ItemUtils;
...
public class Gui {
    ...
    @NotNull
    public Gui setOnPage(@Nullable Pageable action) {
        pager = action;
        return this;
    }
    ...
    protected static String trimTitle(String title) {
        ...
        if (ServerVersion.isAtOrBelow(ServerVersion.V1_8) && title.length() > 32) {
