...
public enum LegacyMaterialAnalogue {
    ...
    LegacyMaterialAnalogue(ServerVersion versionLessThan, String modernAnalouge, String legacyMaterial, Byte legacyData, ServerVersion legacyMinimum, String compatMaterial, Byte compatData) {
        ...
        if (ServerVersion.isBelow(versionLessThan)) {
            if (legacyMinimumVersion != null && ServerVersion.isBelow(legacyMinimumVersion)) {
                // fallback material not available, so use its fallback
                material = Material.getMaterial(compatibleMaterial);
                data = compatibleData;
            } else if (modernMaterial == null || ServerVersion.isBelow(ServerVersion.V1_13)) {
