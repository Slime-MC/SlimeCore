...
public enum CompatibleSound {
    ...
    CompatibleSound(String compatibility_18) {
        try {
            ...
            if (ServerVersion.isAtOrBelow(ServerVersion.V1_9)) {
    ...
    CompatibleSound(Version... versions) {
        try {
            for (Version v : versions) {
                if (v.sound != null && ServerVersion.isAtLeast(v.version)) {
    ...
    CompatibleSound(ServerVersion minVersion, Version... versions) {
        try {
            if (ServerVersion.isAtLeast(minVersion)) {
    ...
    public void stop(Player sendTo) {
        if (ServerVersion.isAtLeast(ServerVersion.V1_10)) {
