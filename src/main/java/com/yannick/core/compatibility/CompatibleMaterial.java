...
public enum CompatibleMaterial {
    ...
    protected static final boolean useLegacy = ServerVersion.isBelow(ServerVersion.V1_13);
    ...
    CompatibleMaterial(ServerVersion modernMinimum, String modern2, ServerVersion modern2Minimum, String legacyMaterial, Byte legacyData) {
        ...
        if (compatibleMaterial != null && ServerVersion.isBelow(compatibleMaterial.versionLessThan)) {
            // server older than this item: use a proxy
            material = compatibleMaterial.material;
            data = compatibleMaterial.data;
        } else if (ServerVersion.isAtLeast(minVersion)) {
            material = Material.getMaterial(modern);
            data = null;
        } else if (modern2 != null && ServerVersion.isAtLeast(minVersion2)) {
            material = Material.getMaterial(modern2);
            data = null;
        } else if (legacyMaterial != null && (compatibleMaterial == null || ServerVersion.isAtLeast(compatibleMaterial.versionLessThan))) {
        ...
        if (material != null && ServerVersion.isBelow(ServerVersion.V1_13) && (compatibleMaterial == null || material != compatibleMaterial.material)) {
    ...
    public boolean usesLegacy() {
        return legacy != null && ServerVersion.isAtOrBelow(minVersion);
    }
    ...
    public static CompatibleMaterial getMaterial(Block block) {
        if (ServerVersion.isAtLeast(ServerVersion.V1_13)) { // Flattening
    ...
    static {
        if (ServerVersion.isAtOrBelow(ServerVersion.V1_12)) {
            try {
    ...
    public void applyToBlock(Block block) {
        ...
        if (data != null && data != -1 && ServerVersion.isAtOrBelow(ServerVersion.V1_12)) {
            try {
    ...
    public static CompatibleMaterial getSpawnEgg(EntityType type) {
        ...
        if (ServerVersion.isBelow(ServerVersion.V1_16) && type == EntityType.valueOf("PIG_ZOMBIE")) {
